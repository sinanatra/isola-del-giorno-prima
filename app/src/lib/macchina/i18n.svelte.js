const STRINGS = {
  ...
  en: {
    ...
    introSticky:
      "Here on this website you can experience an interactive version of Padre Emanuele's dream machine at work. Pull the chain and a drawer will open, serving up an algorithmically sorted batch of quotations from The Island of the Day Before.",
    hint: "Pull the cord",
    langButton: "IT",
  },
};
